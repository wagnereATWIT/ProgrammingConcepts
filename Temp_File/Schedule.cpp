...
//SET & GET FUNCTIONS
void Schedule::setDay(string day) { dayOfWeek = day; }
void Schedule::setStart(int start) { startTime = convertTime(start); }
void Schedule::setEnd(int end) { endTime = convertTime(end); }
