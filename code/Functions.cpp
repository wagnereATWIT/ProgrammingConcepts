...
void CourseDB(sqlite3* DB) {
	...
	// BSME COURSES ---------------------------------------------------------------------------------------
	Q1 = "INSERT INTO COURSE VALUES (32380,'Electromagnetic Field Theory','BSME','MW',8,9,'F',5,7,'Fall',2021,4)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);
...
void ScheduleDB(sqlite3* DB) {
	...
	exit = sqlite3_exec(DB, schedule.c_str(), NULL, 0, &messageError);

	// BSEE COURSES
	Q1 = "INSERT INTO SCHEDULE VALUES (13205, 20005, 10001, 10002, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	Q1 = "INSERT INTO SCHEDULE VALUES (14887, 20006, 10001, 10002, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	// BSCE COURSES
	Q1 = "INSERT INTO SCHEDULE VALUES (13778, 20003, 10003, 10004, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	Q1 = "INSERT INTO SCHEDULE VALUES (14349, 20004, 10003, 10004, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	// BSCO COURSES
	Q1 = "INSERT INTO SCHEDULE VALUES (32401, 20007, 10005, 10006, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	Q1 = "INSERT INTO SCHEDULE VALUES (14882, 20008, 10005, 10006, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	// BSME COURSES
	Q1 = "INSERT INTO SCHEDULE VALUES (32380, 20001, 10007, 10008, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	Q1 = "INSERT INTO SCHEDULE VALUES (14956, 20002, 10007, 10008, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	// BSCS COURSES
	Q1 = "INSERT INTO SCHEDULE VALUES (14420, 20009, 10009, 10010, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);

	Q1 = "INSERT INTO SCHEDULE VALUES (14801, 20010, 10009, 10010, 0)";
	exit = sqlite3_exec(DB, Q1.c_str(), callback, 0, &messageError);
}
